        ...
        <div className="flex items-center justify-between mt-2 pt-2 border-t border-(--color-base-300)">
          ...
          {itemCount > 0 ? (
            ...
            <button
              ...
              className="text-sm font-bold px-2 py-1 rounded-full border border-(--color-primary) text-(--color-primary) flex items-center gap-1 hover:bg-(--color-primary) hover:text-(--color-primary-content) transition disabled:opacity-60 disabled:cursor-not-allowed"
            >
